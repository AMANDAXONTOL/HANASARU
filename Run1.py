...
# https://github.com/LuthfiXayorana 
# WA : 6283861251898
...
dump, dump2, news = [], [], []
sys.stdout.write('\x1b]2; Facebook Craking | @LuthfiXayorana\x07')

class REQ:
   
   def __init__(self):
       self.ses = requests.Session()
       self.url = "https://github.com/LuthfiXayorana"
       self.OS_mkdir()
   ...
   def Logooo(self):
       Console().print(Markdown(f"## Facebook Cracking. @LuthfiXayorana_"),style='bold yellow')
   ...
   def Publik(self, params, host, user, array, coki):
       try:
           ...
           for xyz in req['data']:
               ...
               Console().print(f'>_ @LuthfiXayorana_ -: {B2}{len(array)}{P2}',end='\r')
        ...
        try:
            for xyc in range(int(total)):
                ...
                if data in dump:pass
                    ...
                    Console().print(f'>_ @LuthfiXayorana_ -: {H2}{len(dump)}.{len(data)}{P2}',end='\r')
        ...
        try:
            ...
            for data in Ambil:
                try:
                    ...
                    Console().print(Markdown(f"## {str(e).title()}"),style='red') ; sleep(3.1) ; sys.exit() 
                Console().print(f'>_ @LuthfiXayorana_ -: {H2}{len(dump)}{P2}',end='\r')
        except FileNotFoundError as e:
            Console().print(Markdown(f"## {str(e).title()}"),style='red') ; sleep(3.1) ; sys.exit()
...
class Furthermore:
   ...
   def asyncAPI(self, user, password):
       prog.update(des,description=f">_ @LuthfiXayorana_ | {self.loop}/{len(dump)} LIVE-:{H2}{self.live} {P2}CHECK-:{K2}{self.check}")
       prog.advance(des) 
...
if __name__=='__main__':
  os.system('xdg-open https://wa.me/+6283861251898?text=*Assalamualaikum%20ijin%20pake%20scriptnya%20bang*')
  try:
